fission spec init
fission env create --spec --name onb-br-suitability-env --image nexus.sigame.com.br/fission-onboarding-br-suitability:0.1.1 --poolsize 0 --version 3 --imagepullsecret "nexus-v3" --spec
