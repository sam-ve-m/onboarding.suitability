...
@pytest.mark.asyncio
@patch('func.src.transports.audit.transport.Persephone.send_to_persephone', return_value=(1, 0))
@patch('func.src.transports.audit.transport.config')
async def test_when_success_to_record_message_then_return_true(mock_config, mock_persephone):
...
@pytest.mark.asyncio
@patch('func.src.transports.audit.transport.Persephone.send_to_persephone', return_value=(0, 0))
@patch('func.src.transports.audit.transport.config')
